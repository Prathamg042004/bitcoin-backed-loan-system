...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/loans/loansSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureLoansCols';
...
const TableSampleLoans = ({
  ...
  useEffect(() => {
    if (loansNotify.showNotification) {
      notify(loansNotify.typeNotification, loansNotify.textNotification);
    }
  }, [loansNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/loans/loans-view/?id=${id}`);
  };
...
export default TableSampleLoans;
