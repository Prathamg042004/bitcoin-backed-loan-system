...
const Dashboard = () => {
  ...
  const [loans, setLoans] = React.useState('Loading...');
  const [virtual_wallets, setVirtual_wallets] = React.useState('Loading...');
    ...
    <>
      ...
      <SectionMain>
        ...
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6'>
          ...
          {hasPermission(currentUser, 'READ_LOANS') && (
          ...
          {hasPermission(currentUser, 'READ_VIRTUAL_WALLETS') && (
            <Link href={'/virtual_wallets/virtual_wallets-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
                ...
                <div className='flex justify-between align-center'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiWallet || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
