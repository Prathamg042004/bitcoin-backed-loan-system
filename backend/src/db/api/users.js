...
module.exports = class UsersDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.loans_borrower = await users.getLoans_borrower({
      transaction,
    });

    output.loans_lender = await users.getLoans_lender({
      transaction,
    });

    output.virtual_wallets_owner = await users.getVirtual_wallets_owner({
      transaction,
    });
