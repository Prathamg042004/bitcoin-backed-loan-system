...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '1d6cbea38eddda96ea88e2fb5166f7a6',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'bitcoin backed loan system <app@flatlogic.app>',
  ...
  project_uuid: '51fb1292-4fec-4f3f-8c50-9f54a1b7c48d',
  flHost:
...
config.pexelsQuery = 'abstract digital blockchain concept';
config.host =
